...
public class PsqlWeightRepositoryTest {
    ...
    public void beforeClass() {
        ...
        Weight apple = new Weight(new Plu(1), new Name("苹果", "apple"), new Domestic("610528", "富平县"), new Specification("90#"), GradeEnum.ONE_LEVEL, new ShelfLife(15),
                lastReceiptPrice, retailPrice, WeightMemberPrice.ZERO_KILOGRAM_RMB, vipPrice, 55308263825858876L, Brand.UNBRANDED.id());
        ...
        Weight marbled = new Weight(new Plu(100), new Name("猪五花肉", "pig marbled meat"), new Domestic("510500", "泸州"), new Specification("散装"), GradeEnum.ONE_LEVEL, ShelfLife.THREE_DAY,
                WeightLastReceiptPrice.ZERO_KILOGRAM_RMB, retailPrice, memberPrice, WeightVipPrice.ZERO_KILOGRAM_RMB, 55308263825858876L, Brand.UNBRANDED.id());
        ...
        Weight pig_intestine = new Weight(new Plu(101), new Name("猪蹄", "pig's feet"), new Domestic("510522", "合江县"), new Specification("先切"), GradeEnum.ONE_LEVEL, ShelfLife.THREE_DAY,
                WeightLastReceiptPrice.ZERO_KILOGRAM_RMB, retailPrice, memberPrice, WeightVipPrice.ZERO_KILOGRAM_RMB, 55307862716180229L, Brand.UNBRANDED.id());
        ...
        Weight tenderloin = new Weight(new Plu(102), new Name("猪大肠", "pig intestine"), MadeIn.UNORIGINATED, new Specification("先切"), GradeEnum.ONE_LEVEL, ShelfLife.THREE_DAY,
                WeightLastReceiptPrice.ZERO_KILOGRAM_RMB, retailPrice, memberPrice, WeightVipPrice.ZERO_KILOGRAM_RMB, 55307862716180229L, Brand.UNBRANDED.id());
        ...
        Weight crucian_carp = new Weight(new Plu(410), new Name("鲫鱼", "crucian carp"), new Domestic("510504", "龙马潭"), new Specification("鲜活"), GradeEnum.ONE_LEVEL, ShelfLife.SAME_DAY,
                lastReceiptPrice, retailPrice, memberPrice, WeightVipPrice.ZERO_KILOGRAM_RMB, 55308663786302342L, Brand.UNBRANDED.id());
        ...
        Weight grass_carp = new Weight(new Plu(411), new Name("草鱼", "grass carp"), MadeIn.UNORIGINATED, new Specification("鲜活"), GradeEnum.QUALIFIED, ShelfLife.SAME_DAY,
                lastReceiptPrice, retailPrice, WeightMemberPrice.ZERO_KILOGRAM_RMB, WeightVipPrice.ZERO_KILOGRAM_RMB, 55308663786302342L, Brand.UNBRANDED.id());
