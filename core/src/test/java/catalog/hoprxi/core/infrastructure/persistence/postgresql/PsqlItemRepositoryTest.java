...
public class PsqlItemRepositoryTest {
    ...
    public void setUp() {
        ...
        Item one = new Item(52496163982907400L, barcode, new Name("150ml彩虹柠檬香电热灭蚊香液", "150ml彩虹电热灭蚊香液"), madeIn, new Specification("150ml"), GradeEnum.QUALIFIED, new ShelfLife(180), lastReceiptPrice, retailPrice, MemberPrice.ZERO_RMB_PCS, VipPrice.ZERO_RMB_PCS, skin.id(), caihong.id());
        ...
        Item two = new Item(52496163982907401L, new EAN_13("6907861181388"), new Name("彩虹电热灭蚊香液橙子香型2瓶装", "彩虹电热灭蚊香液2瓶装"), madeIn, new Specification("2*150ml"), GradeEnum.QUALIFIED, new ShelfLife(180), lastReceiptPrice, retailPrice, MemberPrice.ZERO_RMB_PCS, VipPrice.ZERO_RMB_PCS, skin.id(), caihong.id());
        ...
        Item three = new Item(52496163982907402L, barcode, new Name("彩虹电热灭蚊香液4瓶装（橙子+芒果香型）", "彩虹电热灭蚊香液4瓶装"), madeIn, new Specification("4*120ml"), GradeEnum.QUALIFIED, new ShelfLife(180), lastReceiptPrice, retailPrice, MemberPrice.ZERO_RMB_PCS, VipPrice.ZERO_RMB_PCS, skin.id(), caihong.id());
        ...
        Item six_2 = new Item(52496321492179001L, barcode, new Name("250ml天友纯牛奶", "250ml天友纯牛奶"), Domestic.CHONG_QING, new Specification("250ml"), GradeEnum.QUALIFIED, new ShelfLife(90), lastReceiptPrice, retailPrice, MemberPrice.ZERO_RMB_PCS, VipPrice.ZERO_RMB_PCS, dairy.id(), tianyou.id());
