...
*/
    ...
    public void testFind() {
        Brand brand = repository.find("495651176959596552");
        assertNotNull(brand);
        Brand undefined = repository.find("-1");
    ...
    public void testSave() {
        Brand brand = repository.find("495651176959596602");
        assertEquals(new Name("官的"), brand.name());
        brand.rename(new Name("官响环", "没情商"));
        repository.save(brand);
        brand = repository.find("495651176959596602");
