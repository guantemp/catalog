...
public class PsqlBrandRepositoryTest {
    ...
    public void beforeClass() throws MalformedURLException {
        ...
        logo = URI.create("http://20702897.s21i.faiusr.com/4/ABUIABAEGAAgm4Xc_gUojMuX9AEw4gE4VQ.png").toURL();
        ab = new AboutBrand(URI.create("https://www.dsppa.com/").toURL(), logo, Year.of(1988), "广州市迪士普音响科技有限公司始创于1988年，是一家集公共广播系统、智能无纸化会议系统、电子教学系统和政务大厅协同办公系统的研发、生产和销售为一体的大型国家级高新技术企业");
