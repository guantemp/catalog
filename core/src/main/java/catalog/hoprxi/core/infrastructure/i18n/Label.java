...
public class Label extends NLS {
    ...
    public static String UNIT_ZHA;
    public static String UNIT_SHU;
    public static String UNIT_FU_PAIR;
    public static String UNIT_DING;
    public static String UNIT_PI_CLOTH;
    public static String UNIT_TOU;
    public static String UNIT_WEI;
    public static String UNIT_KE_TREE;
    public static String UNIT_ZHU_PLANT;
    public static String UNIT_DUO;
    public static String UNIT_KE_PARTICLE;
    public static String UNIT_DUAN;
    public static String UNIT_JIE;
    public static String UNIT_CENG;
    public static String UNIT_ZUO;
    public static String UNIT_DONG;
    public static String UNIT_ZHUANG;
    public static String UNIT_JIAN_ROOM;
    public static String UNIT_SUO;
    public static String UNIT_JIA_HOME;
    public static String UNIT_SOU;
    public static String UNIT_BU;
    public static String UNIT_LIE;
    public static String UNIT_ZHOU;
    public static String UNIT_FU_SHEET;
