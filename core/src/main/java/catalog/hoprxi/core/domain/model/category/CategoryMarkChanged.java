 ...
 */
public class CategoryMarkChanged implements DomainEvent {
     ...
     * @param mark
     */
    public CategoryMarkChanged(String id, BufferedImage mark) {
        super();
        this.id = id;
        this.mark = mark;
    ...
    public boolean equals(Object o) {
        ...
        CategoryMarkChanged that = (CategoryMarkChanged) o;
